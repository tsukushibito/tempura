...
use crate::{RenderTarget, Swapchain};
...
impl Renderer {
    pub fn new(
        ...
        let swapchain = Swapchain::new(device, display_handle, window_handle, window_size_provider);
    ...
    pub fn render(&self) {
        unsafe {
            ...
            let render_target = self.swapchain.acquire_next_render_target().unwrap();
